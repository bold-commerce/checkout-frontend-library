import {FetchError, checkInventory, apiTypeKeys, keysToTestFromResponse, methods} from 'src';
...
describe('testing getApplicationState', () => {
    ...
    const apiUrlMock = 'https://api.com/checkout/storefront/123/123/check_inventory';
    ...
    beforeEach(() => {
        ...
        getApiUrlSpy = jest.spyOn(apiUrl, 'getApiUrlWithParams').mockReturnValue(apiUrlMock);
