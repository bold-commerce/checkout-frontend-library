import {apiTypeKeys, baseReturnObject, keysToTestFromResponse, methods, updateShippingAddress} from 'src';
...
describe('testing update shipping address api', () => {
    ...
    test('calling updateShippingAddress w/ success = false', async () => {
        ...
        const res = await updateShippingAddress(shippingAddressMock, 1);
