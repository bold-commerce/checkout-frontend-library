import {apiTypeKeys, baseReturnObject, keysToTestFromResponse, methods, addGuestCustomer, FetchError} from 'src';
...
describe('testing addGuestCustomer', () => {
    ...
    test('failed call (422)', async () => {
        ...
        const res = await addGuestCustomer(firstName, lastName, email, acceptsMarketing, 1);
